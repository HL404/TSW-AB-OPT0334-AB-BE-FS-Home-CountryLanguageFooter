	...
	try {
		(TlIqCustm.languageSelectorFooterPhase2 = {
			...
			changeCSS: function () {
				...
				// 	padding: '0px',
				// });
				jQuery('#countrySelector .js-dropdown-wrapper').css({
					border: '1px solid #4A4A4A',
					'border-radius': '3px',
					width: '240px',
					height: '50px',
				...
				// 	width: '240px',
				// });
				jQuery('#language-selector').find('.js-dropdown-trigger').css({
					'text-align': 'left',
					color: '#4A4A4A',
					'font-size': '12px',
					'font-weight': 'bold',
				...
				jQuery('#countrySelector').find('.js-dropdown-panel').css({
					left: '0px',
					'min-width': '240px',
				});
			...
			moveSection: function () {
				...
				window.interval = setInterval(checkCSS, 500);
			},
